...
class WorkshopForm(ModelForm):
    ...
    def __init__(self, *args, workshop_url, has_perm_to_edit=True, has_perm_to_disable_uploads=False, profile_warnings=None, **kwargs):
        ...
        if self.instance.qualification_problems:
            self.fields['qualification_problems'].help_text = format_html('Aktualnie: <a href="{}">{}</a>', reverse('qualification_problems', args=[self.instance.year.pk, self.instance.name]), os.path.basename(self.instance.qualification_problems.path))
        else:
