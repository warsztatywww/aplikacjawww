...
class CampInterestEmailForm(Form):
    ...
    def __init__(self, *args, user: User = None, is_registered: bool = False, narrow=False, **kwargs):
        ...
        email_css = 'col-12' if narrow else 'col-xl-6'
        button_css = 'col-12' if narrow else 'col-xl-4'
        self.helper.layout = Layout(
            Div(
                Div(Field('email', placeholder='Twój adres e-mail'), css_class=email_css),
                Div(FormActions(button), css_class=button_css),
