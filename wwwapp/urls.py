...
urlpatterns = [
    ...
    path('workshop/<slug:name>/edit/', views.workshop_edit_view, name='workshop_edit'),
    ...
    path('program/', RedirectView.as_view(url='/%d/program/' % settings.CURRENT_YEAR, permanent=False, query_string=True), name='program'),
