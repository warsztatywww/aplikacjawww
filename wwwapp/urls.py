...
urlpatterns = [
    ...
    path('<int:year>/workshop/<slug:name>/priv/', views.workshop_proposal_view, name='workshop_proposal'),
    path('<int:year>/workshop/<slug:name>/edit/', views.workshop_page_edit_view, name='workshop_page_edit'),
    path('<int:year>/workshop/<slug:name>/edit/upload/', views.workshop_page_edit_upload_file, name='workshop_page_edit_upload'),
