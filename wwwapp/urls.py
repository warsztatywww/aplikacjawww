...
urlpatterns = [
    ...
    path('me/costs/<int:year>/', views.costs_mine_view, name='costs_mine'),
    path('<int:year>/costs/reimbursements/', views.costs_reimbursements_view, name='costs_reimbursements'),
    ...
    path(
        '<int:year>/costs/admin/transition/',
    ...
    path('me/costs/<int:year>/invoices/add/', views.costs_invoice_add_view, name='costs_invoice_add'),
    path(
        'me/costs/<int:year>/invoices/<int:invoice_id>/edit/',
        views.costs_invoice_edit_view,
        name='costs_invoice_edit',
    ),
    path(
        'me/costs/<int:year>/invoices/<int:invoice_id>/attachment/',
    ...
    path('program/', views.latest_program_redirect_view, name='latest_program'),
    path('addWorkshop/', views.legacy_workshop_add_redirect_view),
