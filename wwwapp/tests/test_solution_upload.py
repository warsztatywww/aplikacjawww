...
class SolutionUploadViews(TestCase):
    def setUp(self):
        ...
        WorkshopParticipant.objects.create(user_profile=self.participant_user.user_profile, workshop=self.workshop)
    ...
    def test_solution_upload_readonly_after_deadline_sent(self):
        Solution.objects.create(workshop_participant=WorkshopParticipant.objects.get(workshop=self.workshop, user_profile=self.participant_user.user_profile))
        self.client.force_login(self.participant_user)
    ...
    def test_solution_upload_accessible_empty(self):
        ...
        solution = Solution.objects.get(workshop_participant=WorkshopParticipant.objects.get(workshop=self.workshop, user_profile=self.participant_user.user_profile))
    ...
    def test_solution_upload_accessible_edit(self):
        with freeze_time('2020-01-01 00:00:00'):
            initial_solution = Solution.objects.create(workshop_participant=WorkshopParticipant.objects.get(workshop=self.workshop, user_profile=self.participant_user.user_profile), message='iks de')
    ...
    def test_solution_add_file(self):
        with freeze_time('2020-01-01 00:00:00'):
            initial_solution = Solution.objects.create(workshop_participant=WorkshopParticipant.objects.get(workshop=self.workshop, user_profile=self.participant_user.user_profile), message='To są testy')
    ...
    def test_download_my_solution_file(self):
        solution = Solution.objects.create(workshop_participant=WorkshopParticipant.objects.get(workshop=self.workshop, user_profile=self.participant_user.user_profile), message='To są testy')
    ...
    def test_download_my_solution_file_other(self):
        ...
        admin_participant = WorkshopParticipant.objects.create(workshop=self.workshop, user_profile=self.admin_user.user_profile)
