...
class CampQualificationViews(TestCase):
    ...
    def test_edit_profile(self):
        ...
        self.assertEquals(self.participant_user.first_name, 'Użytkownik')
        self.assertEquals(self.participant_user.last_name, 'Testowy')
        self.assertEquals(self.participant_user.email, 'test@example.com')
        self.assertEquals(self.participant_user.userprofile.gender, 'M')
        self.assertEquals(self.participant_user.userprofile.school, 'Internet WWW')
        self.assertEquals(self.participant_user.userprofile.matura_exam_year, 2038)
        self.assertEquals(self.participant_user.userprofile.how_do_you_know_about, 'GitHub')
        ...
        self.assertEquals(self.participant_user.userprofile.user_info.pesel, '98101672714')
        self.assertEquals(self.participant_user.userprofile.user_info.address, 'Test!')
        self.assertEquals(self.participant_user.userprofile.user_info.phone, '601123456')
        self.assertEquals(self.participant_user.userprofile.user_info.start_date.year, 2020)
        self.assertEquals(self.participant_user.userprofile.user_info.start_date.month, 7)
        self.assertEquals(self.participant_user.userprofile.user_info.start_date.day, 3)
        self.assertEquals(self.participant_user.userprofile.user_info.end_date.year, 2020)
        self.assertEquals(self.participant_user.userprofile.user_info.end_date.month, 7)
        self.assertEquals(self.participant_user.userprofile.user_info.end_date.day, 15)
        self.assertEquals(self.participant_user.userprofile.user_info.tshirt_size, 'XS')
        self.assertEquals(self.participant_user.userprofile.user_info.comments, 'to działa?')
    ...
    def test_admin_can_accept(self):
        ...
        self.assertEquals(wup.status, WorkshopUserProfile.STATUS_ACCEPTED)
    ...
    def test_admin_can_reject(self):
        ...
        wup = WorkshopUserProfile.objects.get(year=2020, user_profile=self.participant_user.userprofile)
        self.assertEquals(wup.status, WorkshopUserProfile.STATUS_REJECTED)
    ...
    def test_admin_can_cancel(self):
        ...
        wup = WorkshopUserProfile.objects.get(year=2020, user_profile=self.participant_user.userprofile)
        self.assertEquals(wup.status, WorkshopUserProfile.STATUS_CANCELLED)
